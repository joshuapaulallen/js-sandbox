...
describe('Advent of Code 2021 - Day 6', () => {
    ...
    it('should count lanternfish of small sample after 18 days', () => {
        ...
        for (let i = 0; i < days; i++) {
            // console.log(lanternfishFlock.countByDaysUntilSpawn);
    ...
    it('should count lanternfish of small sample after 256 days', () => {
        const lanternfishStr = '3,4,3,1,2';
        const days = 256;
        ...
        expect(lanternfishFlock.count()).to.equal(26984457539);
    });
    ...
    it('should count lanternfish of large sample after 256 days', async () => {
        const lanternfishStr = await fs.readFileSync(inputFile, 'utf-8').trim();
        const start = new Date();
